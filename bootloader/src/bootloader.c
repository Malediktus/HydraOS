...
void _putchar(char character)
{
    ...
    volatile unsigned char *vga_memory = (volatile unsigned char *)VGA_MEMORY;
    unsigned short offset = (cursor_row * VGA_WIDTH + cursor_column) * 2;
...
#define MMAP_CONVENTIONAL 1
#define MMAP_RESERVED 2
#define MMAP_ACPI_RECLAIMABLE
